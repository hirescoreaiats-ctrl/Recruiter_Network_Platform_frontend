  ...
  try {
    ...
    layout(`<div class="candidate-job-portal cjf-page">
      ...
      <div class="cjf-layout"><main><div class="cjf-results-head"><div><b><span id="cjf-count">${matches.length}</span> recommended jobs</b><small>Based on your current candidate profile</small></div><span>Last updated ${portalText(scanTime)}</span></div><div id="cjf-list" class="cjf-list"></div></main>
        ...
        <section class="cjf-side-card cjf-how"><span>HOW RECOMMENDATIONS WORK</span><ol><li><b>Vendor publishes a role</b><small>Only active requirements enter your feed.</small></li><li><b>Your profile is scored</b><small>Skills, role, experience and location are compared.</small></li><li><b>Best-fit jobs appear</b><small>Higher relevance is shown first.</small></li></ol></section>
